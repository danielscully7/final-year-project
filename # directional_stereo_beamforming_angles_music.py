...
# -----------------------------
listener_a_pos = np.array([2.0, 1.0, 1.0])
listener_b_pos = np.array([3.0, 1.0, 1.0])
...
sf.write("audio/listener_a_angles_music2.wav", stereo_a_angles, sr_a)
sf.write("audio/listener_b_angles_music2.wav", stereo_b_angles, sr_a)

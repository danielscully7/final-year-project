# directional_stereo_beamforming_angles_fixed.py
import numpy as np
...
# -----------------------------
listener_a_pos = np.array([2.0, 3.0, 1.0])
...
sf.write("audio/listener_a_angles.wav", stereo_a_angles, sr_a)
sf.write("audio/listener_b_angles.wav", stereo_b_angles, sr_a)
